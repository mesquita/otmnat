...
\begin{homeworkProblem}[1 - Calcular $\int_{0}^{1} xe^{-x}dx$ de três formas diferentes.]

	\begin{homeworkSection}
		Primeiro calculando a integral indefinida:
		\begin{equation}
		...
		\begin{equation}
		\int_{0}^{1}xe^{-x}dx = -\frac{2}{e} - (-1) = -\frac{2}{e} + 1
 		\end{equation}
	\end{homeworkSection}
